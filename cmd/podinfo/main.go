...
func main() {
	...
	fs.String("ui-color", "#A5C6F2", "UI color")
	fs.String("ui-message", fmt.Sprintf("This message is from the podinfo with container developer iteration v%v", version.VERSION), "UI message")
